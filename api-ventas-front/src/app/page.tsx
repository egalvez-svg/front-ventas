...
import { LayoutDashboard, Store, UtensilsCrossed, Receipt, Loader2 } from "lucide-react";
...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-stone-100 dark:bg-slate-950 text-stone-900 dark:text-slate-50 flex flex-col">
      <AppHeader
        icon={<Store className="w-5 h-5 text-white" />}
        title="Garage Restaurant"
      />
